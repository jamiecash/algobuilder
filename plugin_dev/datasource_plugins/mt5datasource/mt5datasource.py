...
class MT5DataSource(ds.DataSourceImplementation):
    ...
    def get_prices(self, symbol: str, from_date: datetime, to_date: datetime, period: str,
        ...
        :param symbol_info: A dict of additional symbol required. Must include point and digits.
        ...
        if timeframe is not None:
            ...
            # We will also need the point and digits to calculate the ask, as MT5 only includes bid on candles. Ask is
            # bid + (bid * price spread * point) rounded to digits
